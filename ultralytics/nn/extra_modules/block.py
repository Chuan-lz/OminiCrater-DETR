...
from ..modules.block import RepC3, CSP
...
__all__ = [ 'MAGI', 'SPDConv', 'ConvolutionalGLU', 'CSPOmniKernel'
           ]
...
class MAGI(CSP):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(MMSA_CGLU(self.c) for _ in range(n))
